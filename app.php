  ...
  <table class="table table-hover table-lg">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>@twitter</td>
        <td>
          <button type="button" data-toggle="modal" data-target="#editApp"class="btn btn-success btn-sm">Modify</button>
        </td>
        <td>
          <button type="button" data-toggle="modal" data-target="#deleteApp"class="btn btn-danger btn-sm">Delete</button>
        </td>
      </tr>
    </tbody>
  </table>
...
<!--edit button-->
<div class="modal fade" id="editApp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<!--delete button-->
<div class="modal fade" id="deleteApp" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
